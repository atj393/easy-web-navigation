...
- [ ] Manifest version is correct (currently **1.0.2**) and matches both packages.
...
- [ ] Upload `artifacts/chrome/easy-web-navigation-chrome-v1.0.2.zip`.
...
- [ ] Upload `artifacts/edge/easy-web-navigation-edge-v1.0.2.zip`.
...
- [ ] Tag the release in git after submission (e.g. `v1.0.2`).
