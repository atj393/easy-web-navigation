...
| 5   | `05-tab-path.png`          | `broken-keyboard-page` | Toggle **Show keyboard path**                     | Numbered markers + the "keyboard items" summary and the **Number of keyboard path markers** control |
